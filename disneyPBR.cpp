...
// 初期化処理
//=============================================================================
HRESULT DisneyPBRModel::InitPolygonModel()
{

	//シェーダー読み込み
	CreateVertexShader(&g_VertexShader, &g_VertexLayout, "disneyPBRVS.cso");
	CreatePixelShader(&g_PixelShader, "disneyPBRPS.cso");
...
// 終了処理
//=============================================================================
void DisneyPBRModel::FinalizePolygonModel()
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void DisneyPBRModel::UpdatePolygonModel(void)
{
	//適当に回転
	Rotate.y += 0.3f;
	Rotate.x += 0.1f;
...
// 描画処理
//=============================================================================
void DisneyPBRModel::DrawPolygonModel()
{
	SetLight(Light);
