...
// 初期化処理
//=============================================================================
HRESULT Toon1Model::InitPolygonModel(void)
{
...
// 終了処理
//=============================================================================
void Toon1Model::FinalizePolygonModel(void)
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void Toon1Model::UpdatePolygonModel(void)
{
	//適当に回転
	Rotate.y += 0.3f;
	Rotate.x += 0.1f;
...
// 描画処理
//=============================================================================
void Toon1Model::DrawPolygonModel(void)
{
	SetLight(Light);
