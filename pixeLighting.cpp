...
// 初期化処理
//=============================================================================
HRESULT PixelLightingModel::InitPolygonModel(void)
{
...
// 終了処理
//=============================================================================
void PixelLightingModel::FinalizePolygonModel(void)
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void PixelLightingModel::UpdatePolygonModel(void)
{
	//適当に回転
	Rotate.y += 0.3f;
	Rotate.x += 0.1f;
...
// 描画処理
//=============================================================================
void PixelLightingModel::DrawPolygonModel(void)
{
	SetLight(Light);
