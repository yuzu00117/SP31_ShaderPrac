...
// 初期化処理
//=============================================================================
HRESULT VertexDirectionalLightingModel::InitPolygonModel(void)
{

	//シェーダー読み込み
	CreateVertexShader(&g_VertexShader, &g_VertexLayout, "vertexDirectionalLightingVS.cso");
	CreatePixelShader(&g_PixelShader, "vertexDirectionalLightingPS.cso");

	//ライトパラメータを設定
	Light.Diffuse = XMFLOAT4(0.8f, 0.8f, 0.8f, 1.0f);
	Light.Ambient = XMFLOAT4(0.1f, 0.1f, 0.1f, 1.0f);
	Light.Direction = XMFLOAT4(0.2f, -1.0f, 0.0f, 0.0f);
...
// 終了処理
//=============================================================================
void VertexDirectionalLightingModel::FinalizePolygonModel(void)
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void VertexDirectionalLightingModel::UpdatePolygonModel(void)
{
	//適当に回転
	Rotate.y += 0.3f;
	Rotate.x += 0.1f;
...
// 描画処理
//=============================================================================
void VertexDirectionalLightingModel::DrawPolygonModel(void)
{
	SetLight(Light);
