...
// 初期化処理
//=============================================================================
HRESULT PixelLightBlinnPhongModel::InitPolygonModel(void)
{

	//シェーダー読み込み
	CreateVertexShader(&g_VertexShader, &g_VertexLayout, "pixelLightingBlinnPhongVS.cso");
	CreatePixelShader(&g_PixelShader, "pixelLightingBlinnPhongPS.cso");
...
// 終了処理
//=============================================================================
void PixelLightBlinnPhongModel::FinalizePolygonModel(void)
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void PixelLightBlinnPhongModel::UpdatePolygonModel(void)
{
	//適当に回転
	Rotate.y += 0.3f;
	Rotate.x += 0.1f;
...
// 描画処理
//=============================================================================
void PixelLightBlinnPhongModel::DrawPolygonModel(void)
{
	SetLight(Light);
