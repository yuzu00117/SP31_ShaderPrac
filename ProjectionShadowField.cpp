/*==============================================================================
   ...
   頂点管理 [ProjectionShadowField.cpp]
                                 Author :
                                 Date   :
--------------------------------------------------------------------------------
...
static VERTEX_3D ShadowField_Box[BOX_NUM_VERTEX] =
{
	//天井////////////////////////////////////////////
	{//頂点V0 LEFT-TOP
...
// 初期化処理
//=============================================================================
HRESULT ProjectionShadowField::InitProjectionShadowField(void)
{
	...
	//頂点バッファ作成
	{
		...
		//頂点データをコピー
		CopyMemory(&vertex[0], &ShadowField_Box[0], sizeof(VERTEX_3D) * BOX_NUM_VERTEX);
		//書き込み完了
...
// 終了処理
//=============================================================================
void ProjectionShadowField::FinalizeProjectionShadowField(void)
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void ProjectionShadowField::UpdateProjectionShadowField(void)
{
...
// 描画処理
//=============================================================================
void ProjectionShadowField::DrawProjectionShadowField(void)
{
	SetLight(Light);
