...
// 初期化処理
//=============================================================================
HRESULT HemisphereLighting::InitPolygonModel(void)
{

	//シェーダー読み込み
	CreateVertexShader(&g_VertexShader, &g_VertexLayout, "hemisphereLightingVS.cso");
...
// 終了処理
//=============================================================================
void HemisphereLighting::FinalizePolygonModel(void)
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void HemisphereLighting::UpdatePolygonModel(void)
{
	//適当に回転
	Rotate.y += 0.3f;
	Rotate.x += 0.1f;
...
// 描画処理
//=============================================================================
void HemisphereLighting::DrawPolygonModel(void)
{
	SetLight(Light);
