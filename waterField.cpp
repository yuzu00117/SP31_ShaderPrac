...
VERTEX_3D	Water_Box[BOX_NUM_VERTEX] =
{
	//天井////////////////////////////////////////////
	{//頂点V0 LEFT-TOP
...
// 初期化処理
//=============================================================================
HRESULT WaterField::InitWaterField(void)
{

	//テクスチャ読み込み
	int Texture = TextureLoad(L"asset\\texture\\Water.png");
	NormalMapTexID = TextureLoad(L"asset\\texture\\Water_Normal01.png"); // 水面用ノーマルマップ
	...
	//頂点バッファ作成
	{
		...
		//頂点データをコピー
		CopyMemory(&vertex[0], &Water_Box[0], sizeof(VERTEX_3D) * BOX_NUM_VERTEX);
		//書き込み完了
...
// 終了処理
//=============================================================================
void WaterField::FinalizeWaterField(void)
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void WaterField::UpdateWaterField(void)
{
...
// 描画処理
//=============================================================================
void WaterField::DrawWaterField(void)
{
	SetLight(Light);
...

	{
		...
		// ノーマルマップをセット
		ID3D11ShaderResourceView* normalTex = GetTexture(NormalMapTexID);
		GetDeviceContext()->PSSetShaderResources(1, 1, &normalTex); // register(t1) にバインド
